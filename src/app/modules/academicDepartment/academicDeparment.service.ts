...
const updateGetAcademicDepartmentsIntoDB = async (id:string,payload:Partial<TAcademicDepartment>) => {
...
export const academicDepartmentServices ={
    ...
    getAcademicDepartmentsIntoDB,singleGetAcademicDepartmentsIntoDB,
